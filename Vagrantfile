...
Vagrant.configure(2) do |config|
    ...
    config.vm.define "r1" do |r1|
	  ...
	  r1.vm.network "private_network", ip: "192.168.11.101", virtualbox__intnet: false
      r1.vm.hostname = "r1"
    end
    ...
    config.vm.define "r2" do |r2|
	  ...
	  r2.vm.network "private_network", ip: "192.168.11.102", virtualbox__intnet: false
      r2.vm.hostname = "r2"
    end
    ...
    config.vm.define "r3" do |r3|
	  ...
	  r3.vm.network "private_network", ip: "192.168.11.103", virtualbox__intnet: false
      r3.vm.hostname = "r3"
    end
